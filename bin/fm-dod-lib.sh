...
Your PR body must carry the \`AgentLab-Evidence-Commit:\`/\`Preservation-Manifest:\` coordinate lines and the crew identity block from this brief's \`# Evidence preservation\` section before it is ready for review.
